		...
		: QSyntaxHighlighter(parent)
{
	...
	tokentypes["transform"] << "scale" << "translate" << "rotate" << "multmatrix" << "color" << "projection" << "hull" << "resize" << "mirror" << "minkowski" << "polarization"/*¼«»¯×ø±ê[o_width, o_height, k_x, k_y] */ ; //modify by Look
